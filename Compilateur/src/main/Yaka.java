...
/**************************************/
  static final public void analyse() throws ParseException {
    ...
    jj_consume_token(PRINCIPAL);
               yvm.princ();fonction.setMain(true);
    bloc();
 ...
 */
  ...
  static final public void valeur() throws ParseException {
    ...
    case entier:
      jj_consume_token(entier);
                 expression.empileIdent(new IdConst(Type.ENTIER, YakaTokenManager.entierLu),null);
      break;
    case ident:
      jj_consume_token(ident);
            expression.empileIdent(tabIdent.chercheIdent(YakaTokenManager.identLu),YakaTokenManager.identLu);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case 43:
        argumentsFonction();
    ...
    case VRAI:
      jj_consume_token(VRAI);
                 expression.empileIdent(new IdConst(Type.BOOLEEN, -1),null);
      break;
    case FAUX:
      jj_consume_token(FAUX);
                 expression.empileIdent(new IdConst(Type.BOOLEEN, 0),null);
      break;
    default:
      jj_la1[13] = jj_gen;
      jj_consume_token(-1);
...
/******Affectation, entrees, sorties*******/
  ...
  static final public void affectation() throws ParseException {
    jj_consume_token(ident);
                expression.addDest(tabIdent.chercheLocal(YakaTokenManager.identLu));
    jj_consume_token(42);
    expression();
                                                                                                           expression.end();
  }
...
/*******Fonctions*******/
  ...
  static final public void retourne() throws ParseException {
    ...
    expression();
                                  fonction.retourne(expression.depile());
  }
  ...
  static final public void argumentsFonction() throws ParseException {
    ...
    case 51:
      expression();
                            fonction.testParam(expression.depile());
      label_10:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case 40:
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x8100,0x80000,0x200,0x0,0x120000,0x0,0x8100,0x0,0x400000,0x800000,0x1120000,0x120000,0x0,0x120000,0x0,0x400000,0x800000,0x1000000,0x0,0x52000,0x52000,0x52000,0x0,0x1120000,0x4800,0x0,0x8100,0x0,0x1120000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x100,0x50,0x100,0x0,0x3e400,0xc0000,0x300000,0x80850,0x850,0x800,0x50,0x3e400,0xc0000,0x300000,0x80000,0x200,0x47,0x47,0x47,0x5,0x808d0,0x0,0x100,0x0,0x100,0x80850,};
   }
